...
- **Compact Mode** - Reduces row padding to fit more topics on screen
- **Subforum Color Coding** - Colored left border on topic rows based on subforum, with matching color squares in the subforum list
